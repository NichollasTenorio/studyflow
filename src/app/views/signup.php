            ...
            <div class="col-md-5 col-lg-4 mx-auto mt-5">
                <div class="auth-card shadow">
                    <div class="d-flex justify-content-center align-items-center gap-2 mb-4">
                        <h2 class="auth-title mb-0">Signup</h2>
                    ...
                    <form action="/teste/signup" method="post">
                        <div class="mb-3">
                            ...
                            <input name="username" type="text" class="form-control" id="exampleInputUsername" aria-describedby="usernameHelp" placeholder="johndoe" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="text-center mb-3">
                            <a href="/teste/login" class="auth-link">Already have an account? Log in.</a>
                        </div>
                        <div class="d-grid">
